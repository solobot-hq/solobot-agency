      ...
      <div className="max-w-md w-full mx-auto bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_0_50px_-10px_rgba(0,0,0,0.50)] rounded-3xl p-8 md:p-10 relative z-10">
        ...
        <div className="flex flex-col items-center mb-8 space-y-4">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold text-white">Sign in to SoloBot</h1>
            <p className="text-gray-300 mt-2 text-sm">
              Your AI Automation Suite — One Login. Infinite Power.
            </p>
          </div>
        </div>
        ...
        <p className="text-center text-gray-300 mt-6 text-sm">
          ...
          <Link href="/sign-up" className="text-emerald-400 hover:text-emerald-300 ml-1 font-semibold transition-colors">
            Create one
          </Link>
        </p>

...
// Executive Bullet Enhancer: Logic-Based Consequence Injection
const enhanceBullet = (line)=>{
    const l = line.toLowerCase();
    // Specific High-Value Triggers (Priority 1)
    ...
    // Operational Triggers (Priority 2)
    ...
    // Generic Action Triggers (Priority 3 - Fallback)
...
const applyTextTransforms = (text, options, tone)=>{
    let processed = text;
    // STRICT Filter: Remove amateurish "meta" phrases
    const bannedPhrases = [
        "Reflecting on",
        "Simply put",
        "Ideally,",
...
const generateOpener = (recipient, tone, warmth, humanize, mode, hasList, seed)=>{
    ...
    // Formal Mode - STRICT No Pleasantries
    if (mode === "Formal") {
        return `${name},`;
    }
    if (mode === "Shorten" || mode === "Punchy") {
        return `${name},`;
    }
    const salutations = {
        Professional: [
    ...
    // FIX 2: Prevent Opener Stacking.
    // Only add bridge if NOT Formal and NOT using the Purpose-Driven Opener above.
    const bridges = [
...
const generateBodyContent = (points, mode, options, tone)=>{
    ...
    let content = "";
    if (isList) {
        // FIX 1: STRICT GATING for Bullet Enhancements.
        // Shorten and Punchy modes MUST use raw bullets to stay crisp.
        ...
        switch(mode){
            ...
            case "Expand":
                if (tone === "Professional") {
                    // Zero Meta-Narration. Direct List. Decisive Close.
                    ...
                    // Note: Opener handles the intro. We just provide list + close.
...
// --- Master Generator ---
const generateSmartEmail = (data, mode = 'Original')=>{
    ...
    const bodySpacer = mode === "Shorten" || mode === "Punchy" ? "\n\n" : "\n\n";
    return `${subject}\n\n${opener}${bodySpacer}${body}${closing}`;
};
// --- Utilities ---
...
function EmailAssistantPage() {
    ...
    const handleRewrite = (label)=>{
        ...
        const variationSeed = crypto.randomUUID();
        const cleanRewrite = generateSmartEmail(formData, label);
        const newVersion = {
            id: variationSeed,
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            ...
                                            " AI Optimized for Deliverability"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/app/dashboard/email-assistant/page.tsx",
                                        lineNumber: 674,
...
_s(EmailAssistantPage, "md+SeCqzSyCPv2ANg+CE/2P/urw=");
...
//# sourceMappingURL=app_dashboard_email-assistant_page_tsx_187a2afe._.js.map
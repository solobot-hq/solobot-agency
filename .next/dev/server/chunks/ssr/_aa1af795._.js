...
// --- Mock Intelligence Engine (Deterministic) ---
const generateMockLeads = (criteria)=>{
    const seed = criteria.industry.length + criteria.location.length;
    ...
    return [
        ...
        {
            id: "3",
            name: `${criteria.location ? criteria.location.split(',')[0] : 'City'} Ventures`,
            industry: "Venture Capital",
            location: criteria.location || "New York, NY",
            website: "www.cityventures.com",
            email: "invest@cityventures.com",
            size: "1-10",
            confidence: 75,
...
function LeadsEnginePage() {
    ...
    const handleExport = ()=>{
        ...
        alert("Exporting refined lead list to CSV...");
    };
...
//# sourceMappingURL=_aa1af795._.js.map
...
export default function Pricing() {
  ...
  // ✅ Shared Hover/Transition classes - EXPLICITLY UNTOUCHED
        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className={cardStyle}>
            ...
            <button
              ...
              className="mt-10 w-full py-4 rounded-xl font-black uppercase text-[10px] tracking-widest bg-white text-black transition-all group-hover:bg-indigo-600 group-hover:text-white"
            >
              Start Building Now
            </button>
          </div>
          ...
          <div className={`${cardStyle} border-2 border-indigo-500/50`}>
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-indigo-500 text-white text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest whitespace-nowrap">
              Most Popular
            </div>
            ...
            <button
              ...
              className="mt-10 w-full py-4 rounded-xl font-black uppercase text-[10px] tracking-widest bg-indigo-600 text-white transition-all group-hover:bg-indigo-500"
            >
              Start Building Now
            </button>
          </div>

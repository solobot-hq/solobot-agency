...
export default function OverviewPage() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        // UPDATED: Active Bots = 15
        setExecutionStats({
            totalBots: 15, // ✅ FIXED: 15 Bots
            runningTasks: 4, 
            activeCredits: 450, 
            totalCredits: 1000, 
            systemAlerts: 0, 
        ...
        // Restored Activity Feed
        setActivities([
            { id: "a1", action: "Email sent", target: "to 15 prospects", time: "2 mins ago", iconType: "Mail", color: "", bg: "bg-blue-500" },
            { id: "a2", action: "Task completed", target: "Data Scraping", time: "1 hour ago", iconType: "CheckCircle", color: "", bg: "bg-emerald-500" },
            { id: "a3", action: "System alert", target: "High latency", time: "3 hours ago", iconType: "Zap", color: "", bg: "bg-amber-500" }
        ]);
  ...
  return (
    <div className="min-h-screen bg-[#0B1221] text-slate-200 p-6 lg:p-10 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#111827]/40 backdrop-blur-xl border border-white/5 rounded-2xl p-6 flex flex-col justify-between shadow-[0_0_40px_-10px_rgba(0,0,0,0.3)] relative overflow-hidden h-[340px]">
            ...
            <button className="z-10 w-full py-2.5 rounded-xl bg-white/5 border border-white/10 text-xs font-bold text-white hover:bg-white/10 transition-all flex items-center justify-center gap-2 group">
      ...
      {/* BOT LEADERBOARD - RESTORED */}
      <div className="mt-6 bg-[#111827] border border-slate-800 rounded-xl overflow-hidden flex flex-col">
